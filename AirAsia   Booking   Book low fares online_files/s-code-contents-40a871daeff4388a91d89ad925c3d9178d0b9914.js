...
var s_domains = [     
 {site:'www.airasia.com/sg/', rsid:'aa-airasia-sg-prd'},    
 {site:'www.airasia.com/hk/', rsid:'aa-airasia-hk-prd'},    
 {site:'www.airasia.com/au/', rsid:'aa-airasia-au-prd'},    
 {site:'www.airasia.com/bn/', rsid:'aa-airasia-bn-prd'},    
 {site:'www.airasia.com/kh/', rsid:'aa-airasia-kh-prd'},    
 {site:'www.airasia.com/cn/', rsid:'aa-airasia-cn-prd'},    
 {site:'www.airasia.com/ir/', rsid:'aa-airasia-ir-prd'},    
 {site:'www.airasia.com/gb/', rsid:'aa-airasia-gb-prd'},    
 {site:'www.airasia.com/kr/', rsid:'aa-airasia-kr-prd'},    
 {site:'www.airasia.com/mo/', rsid:'aa-airasia-mo-prd'},    
 {site:'www.airasia.com/mm/', rsid:'aa-airasia-mm-prd'},    
 {site:'www.airasia.com/fr/', rsid:'aa-airasia-fr-prd'},    
 {site:'www.airasia.com/id/', rsid:'aa-airasia-id-prd'},    
 {site:'www.airasia.com/jp/', rsid:'aa-airasia-jp-prd'},    
 {site:'www.airasia.com/la/', rsid:'aa-airasia-la-prd'},    
 {site:'www.airasia.com/my/', rsid:'aa-airasia-my-prd'},    
 {site:'www.airasia.com/nz/', rsid:'aa-airasia-nz-prd'},    
 {site:'www.airasia.com/ph/', rsid:'aa-airasia-ph-prd'},    
 {site:'www.airasia.com/lk/', rsid:'aa-airasia-lk-prd'},    
 {site:'www.airasia.com/tw/', rsid:'aa-airasia-tw-prd'},    
 {site:'www.airasia.com/th/', rsid:'aa-airasia-th-prd'},    
 {site:'www.airasia.com/vn/', rsid:'aa-airasia-vn-prd'},    
 {site:'www.airasia.com/in/', rsid:'aa-airasia-in-prd'},    
 {site:'www.airasia.com/sa/', rsid:'aa-airasia-sa-prd'},  
 {site:'www.airasia.com/ot/', rsid:'aa-airasia-ot-prd'},  
        {site:'members.airasia.com/', rsid:'aa-airasia-member-prd'},  
     {site:'member.airasia.com/', rsid:'aa-airasia-member-prd'},    
 {site:'booking.airasia.com', rsid:'aa-airasia-booking-prd'},    
 {site:'booking11.airasia.com', rsid:'aa-airasia-SBP-prd'},  
 {site:'booking11.airasia.com', rsid:'aa-airasia-booking-prd'},  
 {site:'booking2.airasia.com', rsid:'aa-airasia-booking-prd'}      
];     
     
var s_site=s_matchDomain(document.location.href);

var s_account;     
if (s_site){     
 if (s_site.rsid=='aa-airasia-booking-prd')     
 {     
  if(getCookie('s_rsid')){//if cookie is present ,use cookie to set RSID   
   s_account=getCookie('s_rsid');  
  } else{   
   s_account=s_site.rsid;  
  }   
 } else { //if RSID is not booking-prd, then set RSID to country specific RSID    
  s_account=s_site.rsid;   
  setCookie('s_rsid',s_site.rsid,365,'/','.airasia.com');   
 }    
 var s=s_gi(s_account + ',aa-airasia-global')    
}     
else {     
 s_account="aa-airasia-dev";    
...
s.linkInternalFilters="javascript:,airasia.com,#"  
...
if (document.domain=='booking.airasia.com')(s.prop1=document.domain)  
if (document.domain=='www.airasia.com'){  
if(!s.prop1) s.prop1=s.eVar1=s.temp.split(':')[1];//site  
if(!s.prop2) s.prop2=s.eVar2=s.temp.split(':')[2];//language  
if(!s.prop3) s.prop3=s.eVar3=s.temp.split(':')[3];//sub site section  
}  
...
/* Capture eDialog integration variables  */ 
if(!s.eVar9)   
s.eVar9=s.getQueryParam('ed_rid');  
if(!s.eVar10)   
s.eVar10=s.getQueryParam('ed_mid'); 	 
/* Set internal search term base on url query */  
if(!s.eVar8)s.eVar8=s.getQueryParam('query');  
if(s.eVar8) s.eVar8=s.prop8=s.eVar8.toLowerCase();  
var t_search=s.getValOnce(s.eVar8,'ev8',0);  
if(t_search!=='')  
{  
s.events = s.apl(s.events,"event8",",",2);  
}  
if(s.eVar12 && s.eVar13){  
if(!s.eVar14){  
s.eVar14=s.eVar12 + "-" +s.eVar13;  
}  
}  
if(s.eVar15){  
//Calculate Date to Departure  
if(!s.eVar18){  
s.eVar18=Math.ceil(((convertDate(s.eVar15).getTime())-(s.tToday.getTime()))/(s.tOneDay));  
if (s.eVar18==0)s.eVar18="same day"  
}  
//Calculate trip duration  
if(s.eVar15 && s.eVar16){  
s.eVar17=Math.ceil(((convertDate(s.eVar16).getTime())-(convertDate(s.eVar15).getTime()))/(s.tOneDay));  
if (s.eVar17==0)s.eVar17="same day"  
}  
}  
s.events = s.apl(s.events,"event1",",",2);  
if(s.purchaseID)  
s.eVar25=s.purchaseID;  
/* Time Parting */  
s.eVar6=s.getTimeParting('d','8'); // Set day  
s.eVar7=s.getTimeParting('h','8'); // Set hour  
}  
...
function setCookie(c_name,value,exdays,cpath,cdomain)  
{  
var exdate=new Date();  
exdate.setDate(exdate.getDate() + exdays);  
var c_value=escape(value) + ((exdays==null) ? "" : "; expires="+exdate.toUTCString());  
document.cookie=c_name + "=" + c_value + ";path=" + cpath + ";domain="+cdomain;  
}  
...
//match current domain with RSID  
function s_matchDomain(url){  
url=url?url:document.location.href;  
for(d in s_domains){  
if(url.indexOf(s_domains[d].site)>-1){  
return s_domains[d];  
}  
}  
}  
function removeLastChar (str1) {  
...
s.visitorNamespace="airasia"  
s.trackingServer="metrics.airasia.com"  
s.trackingServerSecure="smetrics.airasia.com"  
